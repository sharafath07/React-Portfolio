...
function Contact() {
    ...
    const formInput = "w-full px-4 py-2 rounded border-b-2 border-l-2 text-gray-400 bg-gray-800  focus:ring-1 focus:ring-[#cc2bfb] focus:ring-offset-2 transition duration-300"

    return (
        <div id='contact' className='h-[110vh] w-screen flex orbitron tracking-wide items-center justify-center relative overflow-hidden text-center text-gray-400 w-2/3'>
            <div className='border-2 outline-2 outline-[#cc2bfb] outline-offset-4 p-10 rounded-4xl border-gray'>
                <h1 className='text-5xl font-bold text-[#cc2bfb] mb-4 underline underline-offset-4 decoration-[#cc2bfb]'>Contact <span>Me</span></h1>
                ...
                <form className='flex flex-col items-center gap-4 justify-center'>
                    ...
                    <textarea id="message" rows="4" className={formInput}></textarea>
            ...
            <div className='absolute bottom-4 bg-gray-800 text-center p-4 h-14 w-2/3 flex items-center justify-around gap-4 border-none rounded-full text-[#cc2bfb] text-2xl font-bold outline outline-2 outline-[#cc2bfb] outline-offset-4'>
